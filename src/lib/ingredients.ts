...
export const ingredients: { [key: string]: Ingredient } = {
  ...
  "bixa-orellana-seed-extract": {
    "name": "Bixa Orellana Seed Extract",
  ...
  "cetylhydroxyproline-palmitamide": {
    ...
    "synonyms": [],
    "category": "Emollients",
    "description": "A ceramide-like emollient that helps improve skin barrier function"
  },
  "chlorphenesin": {
    "name": "Chlorphenesin",
    "id": "chlorphenesin",
  ...
  "glycolic-acid": {
    ...
    "synonyms": [],
    "category": "Acids",
    "description": "An AHA (alpha hydroxy acid) useful as an antioxidant, exfoliant, and potential collagen stimulant"
  },
  "glycolipids": {
    "name": "Glycolipids",
    "id": "glycolipids",
  ...
  "glycosphingolipids": {
    ...
    "synonyms": [],
    "category": "Surfactants",
    "description": "A natural surfactant that can also act as an emollient that strengthens the skin barrier"
  },
  "heptapeptide-6": {
    "name": "Heptapeptide-6",
    "id": "heptapeptide-6",
  ...
  "hyaluronic-acid": {
    ...
    "category": "Humectants",
    "description": "Trendy and very effective humectant. We grouped all the different forms of hyaluronic acid together."
  },
  ...
  "hydroxypinacolone-retinoate": {
    ...
    "synonyms": [],
    "category": "Retinoids",
    "description": "A supposedly less irritating retinoid that may be just as effective at stimulating collagen production and skin cell turnover"
  },
  ...
  "lactic-acid": {
    ...
    "synonyms": [],
    "category": "Acids",
    "description": "An multifunctional AHA (alpha hydroxy acid) that exfoliates and acts as a humectant"
  },
  ...
  "linoleic-acid": {
    ...
    "description": "A fatty acid that may improve skin barrier function, help with acne, and fight hyperpigmentation"
  },
  "lysine-hcl": {
    "name": "Lysine Hcl",
    "id": "lysine-hcl",
  ...
  "madecassic-acid": {
    ...
    "synonyms": [],
    "category": "Botanicals",
    "description": "A compound found in Centella Asiatica that may act as an antioxidant, soothe irritation, and promote the production of hyaluronic acid within the skin"
  },
  "magnesium-sulfate": {
  ...
  "mandelic-acid": {
    ...
    "synonyms": [],
    "category": "Acids",
    "description": "A AHA (alpha hydroxy acid) that exfoliates and has anti-bacterial properties that might help with acne"
  },
  "marula-oil": {
    "name": "Marula Oil",
    "id": "marula-oil",
    ...
    "category": "Oils",
    "description": "Oil from the Marula tree, can act as an emollient, antioxidant, and may help reduce redness"
  },
  "melanin": {
    "name": "Melanin",
    "id": "melanin",
  ...
  "pinus-pinaster-bark-extract": {
    ...
    "synonyms": [],
    "category": "Botanicals",
    "description": "A potent antioxidant derived from pine bark that may also improve skin hydration and elasticity, as well as fight sun damage"
  },
  ...
  "pseudoalteromonas-exopolysaccharides": {
    ...
    "synonyms": [],
    "category": "Humectants",
    "description": "A natural humectant that acts a bit like hyaluronic acid but may be more effective as it has film-forming properties"
  },
  "pseudoalteromonas-ferment-extract": {
    ...
    "synonyms": [],
    "category": "Botanicals",
    "description": "Produced by fermenting a strain of marine bacteria, acts as film-forming humectant and may promote skin regeneration"
  },
  "rapeseed-sterols": {
    ...
    "category": "Botanicals",
    "description": "Derived from canola oil, it shows promise as an anti-inflammatory and may improve skin barrier function"
  },
  "resveratrol": {
    "name": "Resveratrol",
    "id": "resveratrol",
    ...
    "synonyms": [],
    "category": "Botanicals",
    "description": "A natural antioxidant derived from grapes, with anti-inflammatory and sun-protective properties"
  },
  "retinaldehyde": {
    "name": "Retinaldehyde",
    "id": "retinaldehyde",
    ...
    "category": "Retinoids",
    "description": "The most potent non-prescription retinoid available, may improve skin texture and reduce wrinkles"
  },
  "retinol": {
    "name": "Retinol",
    "id": "retinol",
  ...
  "rosa-canina-seed-oil": {
    ...
    "synonyms": [],
    "category": "Oils",
    "description": "Oil made from seeds of the rose plant, may have anti-inflammatory properties due to antioxidant content"
  },
  ...
  "sodium-chloride": {
    ...
    "synonyms": [],
    "category": "Minerals",
    "description": "Common table salt, potentially a key ingredient as natural moisturizing factors says that minerals are a key ingredient, but not sure why"
  },
  "sodium-citrate": {
    "name": "Sodium Citrate",
    "id": "sodium-citrate",
  ...
  "sphingolipids": {
    ...
    "synonyms": [],
    "category": "Ceramides",
    "description": "Ceramides are Sphingolipids but not sure which one this refers to. Regardless it is a good skin conditioner."
  },
  ...
  "tremella-fuciformis-sporocarp-extract": {
    "name": "Tremella Fuciformis Sporocarp Extract",
